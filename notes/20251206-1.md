...
请将 .42plugin 目录下的所有 Claude Skills 通过软连接的方式注册到项目的 .claude/skills 目录中，成为能被本项目调用的claude Skill。
...
生成 .42cog/real/real.md 与 .42cog/cog/cog.md，中文版。注意，如果以前有内容，直接备份在同文件夹后（加上日期后）替换。
...
生成.42cog/spec/pm/userstory.spec.md。
...
向量数据库：本地Milvus，云端Zilliz cloud，参考：https://milvus.io/zh ; https://cloud.zilliz.com
Milvus SDK：Node.js，参考：https://milvus.io/docs/zh/install-node.md
