...
type MatchType = 'mutual-needs'

export default function MutualNeedsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-8 px-4">
      ...
      <div className="w-full max-w-4xl mb-8">
        <h1 className="text-2xl font-bold text-gray-900">需求匹配</h1>
        <p className="text-sm text-gray-600 mt-1">找到能提供你需要帮助的人</p>
      </div>
